...
export class Easing {
  ...
  public static createEaseInElastic(s = 1.70158): EasingFunction {
  ...
  public static createEaseOutElastic(s = 1.70158): EasingFunction {
    return function (t: number) {
      let p = 0
      let a = 1
      if (t == 0) return 0
  ...
  public static createEaseInOutElastic(s = 1.70158): EasingFunction {
    return function (t: number) {
      let p = 0
      let a = 1
      if (t == 0) return 0
  ...
  public static createEaseInBack(s = 1.70158): EasingFunction {
    return function (t: number) {
      return (t /= 1) * t * ((s + 1) * t - s)
    }
  }

  public static createEaseOutBack(s = 1.70158): EasingFunction {
    return function (t: number) {
      return (t = t - 1) * t * ((s + 1) * t + s) + 1
    }
  }

  public static createEaseInOutBack(s = 1.70158): EasingFunction {
    return function (t: number) {
